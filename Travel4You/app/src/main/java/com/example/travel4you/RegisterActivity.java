...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextFullName = (EditText) findViewById(R.id.registerNameEditTxt);
        editTextEmail = (EditText) findViewById(R.id.registerEmailEditTxt);
        editTextPassword = (EditText) findViewById(R.id.registerPasswordEditTxt);
                            ...
                            FirebaseDatabase.getInstance().getReference("Users")
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if(task.isSuccessful()){
                                        ...
                                        Toast.makeText(RegisterActivity.this, "User couldn't be registered!", Toast.LENGTH_SHORT).show();
                                    }
